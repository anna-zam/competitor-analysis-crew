...
Автономный многоагентный проект на **CrewAI** с веб-интерфейсом.
Сервис помогает быстро понять сильные и слабые стороны конкурентов, превращая их данные в стратегические рекомендации для вашего бизнеса. Вы узнаете, как использовать слабости конкурентов и где их обойти. Полезен для агентств, маркетологов и малого бизнеса, которые хотят сэкономить время на анализе и принять решения быстрее.

Репозиторий содержит демонстрационную версию продукта; планируется развитие функционала и улучшение UX. Проект может быть адаптирован под реальные бизнес-задачи.
...
![Пример PDF отчёта](reports/example_report.png)
![График CTA](reports/charts/example_cta.png)
...
### 🐳 Деплой на сервер (например, Timeweb)
